...
export const LibraryPanel = () => {
  ...
  const full_lib = [...library.mopidyLibrary];
  ...
  return (
    <VFlex style={{ height: "100%", width: "100%" }}>
      ...
      <Paper
        style={{ height: "100%", overflow: "auto", scrollbarWidth: "thin" }}
      >
        <List style={{ paddingLeft: "10px", paddingTop: 0 }}>
          {full_lib.map((node) => (
            <NodeLeaves node={node} depth={0} key={node.uri} rootElem />
          ))}
        </List>
      </Paper>
    </VFlex>
